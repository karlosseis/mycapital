class BrokersController < ApplicationController
  ...
  # GET /brokers.json
  def index
    @brokers = current_user.brokers.all
  end
  ...
  # GET /brokers/new
  def new
    @broker = current_user.brokers.new
  end
  ...
  # POST /brokers.json
  def create
    @broker = current_user.brokers.new(broker_params)

    respond_to do |format|
      if @broker.save
        format.html { redirect_to brokers_url, notice: 'Broker was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @broker.update(broker_params)
        format.html { redirect_to brokers_url, notice: 'Broker was successfully updated.' }
