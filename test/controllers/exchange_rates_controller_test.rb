...
class ExchangeRatesControllerTest < ActionController::TestCase
  ...
  test "should create exchange_rate" do
    assert_difference('ExchangeRate.count') do
      post :create, exchange_rate: { date_exchange: @exchange_rate.date_exchange, pair: @exchange_rate.pair, rate: @exchange_rate.rate }
    end
  ...
  test "should update exchange_rate" do
    patch :update, id: @exchange_rate, exchange_rate: { date_exchange: @exchange_rate.date_exchange, pair: @exchange_rate.pair, rate: @exchange_rate.rate }
    assert_redirected_to exchange_rate_path(assigns(:exchange_rate))
  end
