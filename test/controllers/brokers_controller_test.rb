...
class BrokersControllerTest < ActionController::TestCase
  ...
  test "should create broker" do
    assert_difference('Broker.count') do
      post :create, broker: { buy_frequency: @broker.buy_frequency, name: @broker.name, user_id: @broker.user_id }
    end
  ...
  test "should update broker" do
    patch :update, id: @broker, broker: { buy_frequency: @broker.buy_frequency, name: @broker.name, user_id: @broker.user_id }
    assert_redirected_to broker_path(assigns(:broker))
  end
